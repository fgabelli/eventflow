    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (_selectedStatusFilter == 'claimed') {
          vouchers = vouchers.where((v) => v.isClaimed).toList();
                ...
                children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: 'claimed', child: Text('Solo Attivati (In attesa check-in)')),
  ...
  Widget _buildRegistrationTile(Organization org, VoucherModel voucher, PromotionModel promo) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isRedeemed ? AppColors.success.withValues(alpha: 0.3) : AppColors.border,
        ),
      ),
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Icon(
              isRedeemed ? Icons.check_circle_rounded : Icons.person_rounded,
