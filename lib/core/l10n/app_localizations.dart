...
class AppLocalizations {
  ...
  static const Map<String, String> _it = {
    ...
    'campaign_deadline_label': 'Termine Campagna (Data Ultima Attivazione)',
    'campaign_deadline_helper': 'Data limite entro cui il cliente può inquadrare e registrare il coupon cartaceo.',
  ...
  static const Map<String, String> _en = {
    ...
    'campaign_deadline_label': 'Campaign Deadline (Last Activation Date)',
    'campaign_deadline_helper': 'Latest date by which the physical coupon can be registered online by the customer.',
